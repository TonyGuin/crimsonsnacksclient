...
var selectMenu = document.getElementById("deptSelect");
...
{
  var clearbody = document.getElementById("table-body")
  clearbody.innerHTML = ""
  getTimeCards();
}
...
{
    selecteddept = selectMenu.options[selectMenu.selectedIndex].text
    let getURL = `https://crimsonsnacksapi321.herokuapp.com/api/TimeStamps/GetDPTTimes/${selecteddept}`
